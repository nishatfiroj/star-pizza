        ...
        <Grid size={size}>
          <Coupon>
            <Grid textAlign="center">
              ...
              <Paragraph>
                25+ years of pizza merits some special pricing!
              </Paragraph>
            </Grid>
            <br />
            <Grid
        ...
        <Grid size={size}>
          <Coupon>
            <Grid textAlign="center" container flexDirection="column">
              ...
              <Paragraph>
                16&quot; extra large pizza with 1 topping for only
              </Paragraph>
          ...
          <Coupon>
            <Grid textAlign="center" container flexDirection="column">
              ...
              <Grid container flexDirection="row" justifyContent="center">
                <Grid size={4}>
                  <Paragraph>
                    Large pizza with 2 toppings and 15 wings
                  </Paragraph>
                  <Heading>$29.99</Heading>
                  <br />
                  <Paragraph>
                    Large pizza with 2 toppings and 10 wings
                  </Paragraph>
                  <Heading>$22.99</Heading>
                </Grid>
                <Grid size={4}>
                  <Paragraph>
                    Medium pizza with 2 toppings and 10 wings
                  </Paragraph>
        ...
        <Grid size={size}>
          <Coupon>
            <Grid textAlign="center" container flexDirection="column">
              ...
              <Paragraph>
                one large specialty pizza and one large 2-topping (add $3 for
                All the Way) for only
              </Paragraph>
              <Heading>$26.99</Heading>
              <Paragraph fontSize={12}>
                (add a jumbo salad for just $10.99)
              </Paragraph>
              <Heading fontSize={24}>OR</Heading>
              <Paragraph>
